...
public class StreamAPITest1 {
    ...
    public void test1() {
        ...
        //   stream.limit(3).forEach(System.out::println); //.IllegalStateException: stream has already been operated upon or closed
    ...
    public void test2(){
      ...
      //  Stream<String> nameStream = employees.stream().map(e -> e.getName());
        ...
        System.out.println();
        //flatMap(Function f)——接收一个函数作为参数，将流中的每个值都换成另一个流，然后把所有的流链接成一个流
...
// 抛异常：.ClassCastException: com.ruiyun.java1.Employee cannot be cast to java.lang.Comparable
